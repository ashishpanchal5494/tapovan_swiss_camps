    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={
            activeTab === "camping"
              ? "Tapovan Swiss Camps offers the best riverside camping in Rishikesh with AC tents, bonfire & adventure activities. Book now for 2024-25 season!"
              : "Experience thrilling rafting on the Ganges with certified guides. Best 16km, 22km & 36km rafting packages from Shivpuri to Rishikesh. Book online!"
          }
        />
        ...
        <meta
          ...
          content={
            activeTab === "camping"
              ? "rishikesh camping, luxury tents rishikesh, ganga riverside & waterfall side camp, best camping in rishikesh, swiss tents booking"
              : "rishikesh rafting, ganga river rafting, shivpuri rafting booking, best rafting in india, white water adventure"
          }
        />

        <link
          rel="canonical"
          href="https://tapovanswisscampsofficial.com/booking-form"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              activeTab === "camping"
                ? "Premium camping experience near the Ganges in Rishikesh"
                : "Adventure rafting on the holy Ganges river",
            address: {
              "@type": "PostalAddress",
